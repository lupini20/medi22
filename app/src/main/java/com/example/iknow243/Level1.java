...
public class Level1 extends AppCompatActivity implements  QuestionResponseHandler,   View.OnClickListener{
    ...
    private QuestionControler controller1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        controller1 = QuestionControler.getInstance();
    ...
    //this functions allows to set the question prompt and the suggestions button
    private void setQuestionView() {

        int randSet = Randomizer.generate(0,(set.size() - 1));
        ...
        //option1
        int randomIndex = Randomizer.generate(1,7);
       ...
       //option2
         randomIndex = Randomizer.generate(1,7);
    ...
    protected void onResume() {
        super.onResume();
        QuestionControler_Level2.destroyInstance();
    }
